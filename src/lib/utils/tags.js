...
const hardcodedTags = [
	...
	{ id: 'idioma', children: ['espanol', 'ingles'], color: 'darkblue' },
	{
		id: 'lugar',
	...
	{ id: 'material', children: ['guía', 'leyenda', 'libro', 'fanzine'], color: 'var(--3-dark)' },
	{ id: 'tipo de material', children: ['guía', 'leyenda', 'libro', 'fanzine'] },
	...
	{ id: 'queer', children: ['mascota', 'furry', 'género', 'asexualidad', 'prácticas'] },
	{
		id: 'asexualidad',
 ...
 * @return {*}
 */
function tagsFactory(rawTags = hardcodedTags) {
	/** @type Array<Tag> */
	/**@type Map<TagID, Tag> */
	...
	// add color getter prop to all tags
	...
	// processedTags.push({
	//     get color() {
	//         return tag.color ?? computeColor(tag)
	//     }
	// })
	return tags;
}
